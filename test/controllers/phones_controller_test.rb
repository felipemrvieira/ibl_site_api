...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post phones_url, params: { phone: { number: @phone.number, unity_id: @phone.unity_id } }, as: :json
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { number: @phone.number, unity_id: @phone.unity_id } }, as: :json
    assert_response 200
  end
